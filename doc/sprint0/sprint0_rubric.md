...
**Team Name:** Chess Website  
**Github:** [GitHub Repo Link](https://github.com/EECS3311F24/Checkmate)
...
## Documentation: README.md (max 3 marks)
  ...
  - Contribution
    ...
    Your mark: 0 (No branching criteria mentioned.
    says PR must follow format but no format discussed.)
...
## User experience: (max 4 marks)
  - User experience is logically related to scenarios (from summary.md) (max 2 marks)
    ...
    Your mark: 1 (UX is hard to follow given the hand drawn UI)
